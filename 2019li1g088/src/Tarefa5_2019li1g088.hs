...
main = do 
     ...
     play ecra                             
          white                            
          frame                         
          (estadoGlossInicial [fundo,ceu,j1,j1m,j2,j2m,j3,j3m,j4,j4m,f1,f2,st,j,re,rel,tf,verde,t1,t2,t3,t4,p1,p2,p3,p4,xx,x,home,jf,pp1,pp2,pp3,pp4,m,m1,r1,r2,r3,r4,nn,rr]) 
          desenhaGLossInicial
          reageAoMOvimento               
          reageAoTempo                     
